...
describe('restoreFastPacket', () => {
  ...
  test('take frame in backward order', () => {
    ...
    const state1 = restoreFastPacket({ canId: 0x18EEFF00, data: d3 }, state)
    ...
    const state2 = restoreFastPacket({ canId: 0x18EEFF00, data: d2 }, state)
    const f2 = [
      undefined,
  ...
  test('take frame in 1,3,2 order', () => {
    ...
    const state1 = restoreFastPacket({ canId: 'foo', data: d1 }, state)
    ...
    const state2 = restoreFastPacket({ canId: 'foo', data: d3 }, state)
    const f2 = [
      hexStrBuff('b8caef00b8ca'),
      undefined,
      hexStrBuff('33ffff00ffffff'),
