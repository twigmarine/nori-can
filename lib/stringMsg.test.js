...
const {
  encodeActisense, encodePgn, encodeYDRAW, parseActisense, parseCandump1,
...
describe('encodePgn', () => {
  test('lawicel', () => {
    const info = { canId: 300, data: hexToBuff('00,00') }
    const res = encodePgn('lawicel', info)
    expect(res).toBe('T0000012C20000\r')
  })
})
...
describe('parseLawicel', () => {
  ...
  test('define parser', () => {
    ...
    expect(parseString('T0000014180D330D2F0D300D33\r', 'lawicel')).toEqual(expect.objectContaining({
      format: 'lawicel',
      len: 8,
      prefix: 'T',
  ...
  test('slice string', () => {
    expect(parseString('T1806E5F4803E8006400000000')).toEqual(expect.objectContaining({
      canId: 0x1806E5F4, // Charger limits.
      prio: 6,
      src: 244, // Battery Management System (BMS)
      dst: 229, // Charger Control System (CCS)
    ...
    expect(parseString('T1806E7F4803E8006400000000')).toEqual(expect.objectContaining({
      canId: 0x1806E7F4,
      prio: 6,
      src: 244,
      dst: 231,
    ...
    expect(parseString('T1806E8F4803E8006400000000')).toEqual(expect.objectContaining({
      canId: 0x1806E8F4,
      prio: 6,
      src: 244,
      dst: 232,
