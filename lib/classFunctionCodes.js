  ...
  codes:
   ...
   },
   {
     ...
     functions:
        ...
        {
          code: 138,
          label: 'Digital to NMEA 2000 Gateway',
          labelDetails: '',
        },
        {
          code: 139,
          label: 'Modbus to NMEA 2000',
          labelDetails: '',
        },
        {
          code: 140,
   ...
   },
   {
     ...
     functions: [
       {
         code: 130,
         label: 'Class A Mobile',
       },
       {
         code: 132,
         label: 'Class B SO (Self-Organizing)',
       },
       {
         code: 134,
         label: 'Class B CS (Carrier Sense)',
       },
       {
         code: 136,
         label: 'SAR Airborne',
       ...
       {
         code: 140,
         label: 'AIS Man Overboard (MOB)',
       },
       {
         code: 142,
         label: 'AIS Personal Locator Beacon (PLB)',
       },
       {
         code: 144,
         label: 'AIS Search and Rescue Transponder (SART)',
       },
       {
         code: 146,
         label: 'AIS Emergency Position Indicating Radio Beacon (EPIRB)',
       },
       {
         code: 150,
         label: 'Aid to Navigation (AtoN) Type 1',
       },
       {
         code: 152,
         label: 'Aid to Navigation (AtoN) Type 2',
       },
       {
         code: 154,
         label: 'Aid to Navigation (AtoN) Type 3',
       },
       {
         code: 156,
         label: 'Mobile Aid to Navigation (AtoN)',
       },
       {
         code: 160,
       ...
       {
         code: 164,
         label: 'Limited Base Station [Reserved for Future Use]',
       },
       {
         code: 170,
         label: 'AIS VHF Data Exchange System (VDES) ASM [Reserved for Future Use]',
       },
     ],
   },
   {
     ...
     functions: [
       {
         code: 130,
         label: 'AIS Receive Only',
       },
       {
         code: 140,
         label: 'Transmits Only Specific Information (Reserved for Future Use)',
       },
     ],
   },
   {
