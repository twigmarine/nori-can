...
const { buffHexStr, hexSpStrBuff } = require('./utilities')
...
describe('parser', () => {
  test('process many line input string', () => {
    ...
    expect(buffHexStr(res[0].field.communicationState.value.buffer)).toBe('00,30,00')
    expect(res[0]).toEqual({
      ...
      fieldData: [
        ...
        3.6408, // COG
        2.31, // SOG
        new DataView(new ArrayBuffer(1)), // Communication State
