const {
  at, camelCase, compact, conforms, curry, defaults, defaultTo, eq,
  filter, flow, fromPairs, get, groupBy, has,
...
function dataPosition(bitIndex = 0) {
...
const pgnInfoById = flow(compact, keyBy('id'))
