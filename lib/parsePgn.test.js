...
const {
  getFieldInfo, parse, parser, splitPgn, toNumber, toUint24,
} = require('./parsePgn')
...
describe('toUint24', () => {
  test('Convert 3 bytes to number', () => {
    expect(toUint24(new DataView(hexStrBuff('14f001').buffer)))
      .toBe(126996)
    expect(toUint24(new DataView(hexStrBuff('00ee00').buffer)))
      .toBe(60928)
  })
})
