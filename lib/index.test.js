...
const {
  hexToBuff, cleanup, canboatGetInfo, createGetInfo,
...
describe('parser', () => {
  ...
  test('parse a chunk of string lines', () => {
    ...
    expect(val).toEqual({
      ...
      totalFrames: 4,
      data: hexToBuff('12 01 23 29 14 81 e1 23 d6 ec aa 04 1a 32 5a 76 00 00 c0 00 c0 ff 7f 00 c2 ff'),
      field: {
        ...
        regionalApplication1: {
          bitLength: 2, name: 'Regional Application', value: 2,
        },
        unitType: {
          bitLength: 1,
          type: 'Lookup table',
...
describe('dataParser', () => {
  ...
  test('single packet works', () => {
    ...
    expect(cleanup(res[0])).toEqual({
      ...
      msgId: '9F1120D',
      category: 'Unknown',
      data: hexToBuff('00 9D 16 FF 7F FF 7F FD'),
      time: '20:43:04.296',
      field: {
        deviation: {
          bitLength: 16,
