...
const {
  buffHexStr, hexSpStrBuff, cleanup, createGetInfo,
...
describe('parser', () => {
  ...
  test('parse a chunk of string lines', () => {
    ...
    expect(buffHexStr(val.field.communicationState.value.buffer)).toBe('06,00,06')
    expect(val).toEqual({
      canId: 301469443,
      prio: 4,
      src: 3,
      ...
      field: {
        ...
        communicationState: {
          ...
          value: new DataView(new ArrayBuffer([0x06, 0x00, 0x06])),
        },
